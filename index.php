...
<!-- Mirrored from thememarch.com/demo/html/medical/trustlife/home-version-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Aug 2020 08:18:17 GMT -->
<head>
	<!-- Meta Tags -->
	<meta charset="utf-8">
	...
	<!-- Page Title -->
	<title>Central Neuro System Trading Company</title>
    <!-- Favicon Icon -->
                    ...
                    <nav class="tm-primary-nav">
                        <ul class="tm-primary-nav-list">
                            <!-- <li class="menu-item menu-item-has-children current-menu-ancestor current-menu-parent">
                                ...
                                <ul>
                                    <li class="menu-item"><a href="index-2.html">Home1 (Default Version)</a></li>
                            ...
                            <!-- <li class="menu-item"><a href="#appointment" class="nav-link">APPOINTMENT</a></li> -->
                        </ul>
                    </nav>
    ...
    <section class="hero tm-bg parallax" id="home" style="background-image: url(assets/img/bg_green.jpg);">
        <div class="container">
            <div class="slider-text">
                    <h1 class="tm-headline letters tm-rotate-text"><span style="color:#2caee2; font-weight: bold;">CENTRAL NEURO SYSTEM TRADING Co.</span><br>
        
                    <span class="tm-words-wrapper">
                        <b class="is-visible">FROM&nbsp;START</b>
                        <b>TO&nbsp;FINISH</b>
                    </span>
                </h1>
                <div class="empty-space col-sm-b20 col-xs-b10"></div>
                <p>We are a group of dynamic, highly business oriented, and compassionate professionals, whose aim is basically to provide affordable yet of high caliber medical equipments.</p>
            ...
            <div class="row">
                <div class="col-lg-3" >
                    ...
                    <div class="tm-icon-box style1">
                        <div class="tm-icon"><i class="fa fa-flag"></i></div>
                        <h2 class="tm-icon-box-title">2016</h2>
                        <p class="tm-icon-box-text">Started with products of Jeil Medical Corporation, the Le Forte System</p>
                    </div>
                </div><!-- .col -->
                <div class="col-lg-3">
                    <div class="empty-space col-md-b0 col-xs-b30"></div>
                    <div class="tm-icon-box style1">
                        <div class="tm-icon"><i class="fa fa-flag"></i></div>
                        <h2 class="tm-icon-box-title">2017</h2>
                        <p class="tm-icon-box-text">Exclusive Distributorship of Neurosurgical Line of Integra life Sciences</p>
                    </div>
                </div><!-- .col -->
                <div class="col-lg-3">
                    <div class="empty-space col-md-b0 col-xs-b30"></div>
                    <div class="tm-icon-box style1">
                        <div class="tm-icon"><i class="fa fa-flag"></i></div>
                        <h2 class="tm-icon-box-title">2018</h2>
                        <p class="tm-icon-box-text">Exclusive Distributorship of ADEOR, NEOS SURGERY, AMERICAN SURGICAL COMPANY, SURTEX Instruments and TRISEL.
                            Batanes General Hospital (Big Account) - Started delivering different medical supplies, equipments and instruments.
                        </p>
                    </div>
                </div><!-- .col -->
                <div class="col-lg-3">
                    ...
                    <div class="tm-icon-box style1">
                        <div class="tm-icon"><i class="fa fa-flag"></i></div>
                        <h2 class="tm-icon-box-title">2019</h2>
                        <p class="tm-icon-box-text">Began participating in government biddings. Have delivered various medical/surgical equipment and instruments.</p>
                    </div>
                </div><!-- .col -->
                        ...
                        <div class="">
                            ...
                            <div class="accordian">
                                <div class="single-accordian">
                                    <h3 class="accordian-head">Mission</h3>
                                    <div class="accordian-body">
                                        <ul>
                                            <li>To find innovative healthcare products and services that will enhance our patients’ quality of life.</li>
                                            <li>Formulate ideas on how doctors would benefit through our products at the same time being mindful of our patients’ welfare.</li>
                                            <li>To be known as a company that provides high quality healthcare products and services while keeping the costs for the patients at bay.</li>
                                            <li>Improve the company’s welfare and create an atmosphere where employees and key executives work harmoniously in reaching our goals.</li>
                                        </ul>
                                    </div>
                                </div><!-- .single-accordian -->
                                <div class="single-accordian">
                                    <h3 class="accordian-head">Vision</h3>
                                    <div class="accordian-body">Central Neuro Systems Trading Co. aims to achieve sustainable growth while providing quality service to our clients.  To be at the forefront of companies delivering the best and most innovative healthcare products while being mindful of our company’s core values and social responsibilities as well.</div>
                                </div><!-- .single-accordian -->
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="tm-about-wrap tm-hf-hide">
                            <div class="tm-about tm-gray-bg wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.1s">
                                <h3 class="tm-about-title">Why People Choose <span>Central Neuro System</span>?</h3>
                                <div class="tm-about-text">
                                    <p>Central Neuro Systems Trading Co. (CNSTC) was born in 2016 located at Room 306 Avenida Bldg. 1758 Malabon St. Sta. Cruz, Manila in the heart of a group of dynamic, highly business oriented, and compassionate professionals, whose aim is basically to provide affordable yet of high caliber implants, medical devices, hospital equipment, and other healthcare products to patients and the community.</p>
    ...
    <!-- <section class="tm-relative" id="appointment">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <div class="empty-space col-md-b60 col-xs-b40"></div>
                    <form method="POST" action="http://thememarch.com/demo/html/medical/trustlife/assets/php/appointment.php" class="tm-appointment-form" id="appointment-form">
                ...
                <div class="col-lg-12">
                    <div class="tm-pricing-carousel owl-carousel tm-nam-tm-style1 tm-dots1">
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <h2 class="tm-pricing-heading">Warehousing and Storage</h2>
                            ...
                            <a href="#contact" class="tm-btn1">CONTACT NOW</a>
                        </div>
                        <div class="tm-price-list tm-gray-bg">
                            <div class="tm-price">
                                <!-- <h3>$30</h3> -->
                            </div>
                            <h2 class="tm-pricing-heading">Delivery and Transportation</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
                        ...
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <h2 class="tm-pricing-heading">Provision of an Experienced or <br/>Technician During Surgeries</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
                        ...
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <h2 class="tm-pricing-heading">Sales Order Processing</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
                        ...
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <div class="pricing-shap"></div>
                            <h2 class="tm-pricing-heading">Invoicing</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
                        ...
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <div class="pricing-shap"></div>
                            <h2 class="tm-pricing-heading">Collection</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
                        ...
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <div class="pricing-shap"></div>
                            <h2 class="tm-pricing-heading">Credit and Risk Management</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
                        ...
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <div class="pricing-shap"></div>
                            <h2 class="tm-pricing-heading">Sales and Marketing</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
                        ...
                        <div class="tm-price-list tm-gray-bg">
                            ...
                            <div class="pricing-shap"></div>
                            <h2 class="tm-pricing-heading">On Call Technician for Equipment</h2>
                            <ul class="tm-test-list">
                                <li>First Description</li>
                                <li>Second Description</li>
                                <li>Third Description</li>
            ...
            <div class="container"><!-- row-md-reverce -->
                <div class="row row-sm-reverce">
                    <div class="col-md-7 col-lg-8">
                        <p class="tm-copyright">Copyright © 2020 Central Neuro System Trading Co.</p>
                    </div><!-- .col -->
